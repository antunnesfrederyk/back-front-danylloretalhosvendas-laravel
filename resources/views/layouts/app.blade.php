                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <div class="dropdown show m-1">
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                <a class="dropdown-item" href="{{route('adminprodutos.index')}}">Produtos</a>
                                <a class="dropdown-item" href="{{route('adminprodutos.create')}}">Novo Produto</a>
                            </div>
                        </div>
