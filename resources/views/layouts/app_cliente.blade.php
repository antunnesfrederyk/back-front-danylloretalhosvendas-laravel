    ...
    <div id="app">
        ...
        <nav class="d-lg-none navbar navbar-light bg-white fixed-top">
            <a class="navbar-brand" href="{{ url('/') }}">
               <img src="{{asset('brasao.png')}}" height="35px">
        ...
        <div class="d-none d-lg-block bg-white pt-2 pl-2 fixed-top" id="buscar">
            <form action="{{route('buscar')}}" method="GET">
                <div class="row">
                    <div class="col-3">
                        <a class="navbar-brand" href="{{ url('/') }}">
                        <img src="{{asset('brasao.png')}}" style="margin-left: 10px" height="45px">
{{--                        <img class="ml-2" src="{{asset('rede.png')}}" height="40px">--}}
                        </a>
                    </div>
...
<div class="col-12" align="center">
    <p style="color: white">Dúvidas?&nbsp;&nbsp;&nbsp;<a href="https://api.whatsapp.com/send?phone=5583996551689&text=Olá! Estou com uma dúvida!" class="btn btn-primary">Clique aqui</a></p>
    ...
    <p style="margin: 0; padding: 0; color: white"><strong>Contatos: </strong>(83) 3457-2119 / (83)99655-1689</p>
    <p style="color: grey">2020 © atdsistemas.com.br</p>
</div>
    </div>

    <!-- Global site tag (gtag.js) - Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-169193080-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag(){dataLayer.push(arguments);}
        gtag('js', new Date());

        gtag('config', 'UA-169193080-1');
    </script>
</body>
</html>
