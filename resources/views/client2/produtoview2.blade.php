                    ...
                    <h6 align="justify">
                       ...
                       <div class="container" style="margin-top: 50px">
                           <div class="col-lg-8 col-12  float-left">
                               ...
                               <h6 style="margin: 0; padding: 0; color: grey">Até 10x no cartão / 1+3 Crediário</h6>
                               <p class="pb-5" style="margin: 0; padding: 0; color: grey">À vista (Desconto especial)</p>
                           </div>
                           <div class="col-lg-4 col-12 float-right">
                               <button  onclick="quantidade({{$produto->id}}, '{{$produto->nome}}')" data-toggle="modal" data-target="#exampleModal"   class="btn btn-primary" style="width: 100%; margin-bottom: 20px; margin-top: 10px">Adicionar ao Carrinho&nbsp;&nbsp;<i class="fas fa-cart-plus"></i></button>
                           </div>
                       </div>
                </div>
